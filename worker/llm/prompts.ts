...
3. meaningful_conviction: The purchase size is a meaningful share of the director's estimated annual compensation — roughly more than one month's pay for an executive, or more than £30k absolute for a non-exec.
...
5. supporting_context_found: Your web search found at least one RNS, result, trading update, drawdown, or catalyst that makes the timing plausible as an informed bet.
6. no_major_counter_signal: The purchase is not undermined by a major contrary signal — no director selling elsewhere simultaneously, no profit warning in the prior 60 days, no open governance or regulatory investigation.
