...
export const CHECKLIST_LABELS: { key: keyof RatingChecklist; label: string; tooltip: string }[] = [
  {
    key: "open_market_buy",
  ...
  },
  {
    ...
    tooltip: "The purchase doesn't appear to result from a pre-arranged trading plan, SAYE/10b5-1 plan, or required ownership policy — suggesting it's an active investment decision.",
  },
  {
...
export function RatingChecklistView({ checklist }: { checklist: RatingChecklist }) {
