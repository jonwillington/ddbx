...
export function DealingRowHeader({ sticky = false, showVsFtse = false }: { sticky?: boolean; showVsFtse?: boolean }) {
  return (
    <div className={`hidden md:flex items-center text-xs text-muted font-medium select-none border-b border-black/[0.08] dark:border-white/[0.08] bg-black/[0.04] dark:bg-white/[0.05] rounded-t-xl ${sticky ? "sticky top-32 z-[9]" : ""}`}>
